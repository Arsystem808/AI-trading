        ...
        st.markdown(
            ...
            <div style="border-radius:8px;overflow:hidden;
              ...
              <div style="background:{BLACK};padding:12px 16px 16px 16px;">
                <div style="max-width:1120px;margin:0 auto;">
                  <div style="color:#fff;font-size:clamp(15px,2.4vw,27px);opacity:.92;">trade smarter.</div>
                </div>
              </div>
            </div>
            """,
...
CUSTOM_PHRASES = {
    ...
    "WAIT": [
        "ППока нет ясности с картиной на текущем горизонте, и я не спешу с решениями.",
...
if st.session_state.get('show_arxora', False):
    st.markdown(
        ...
        <div style="background-color: #000000; color: #ffffff; padding: 15px; border-radius: 10px; margin-top: 10px;">
            ...
            делая торговлю проще, эффективнее и разумнее. Ключевые особенности платформы:
            AI override: Интеллектуальная функция, которая в режиме реального времени может корректировать или отменять ранее сгенерированные сигналы и ордера, учитывая новые данные и экстремальные рыночные ситуации, что повышает безопасность и оптимальность торговых решений.
