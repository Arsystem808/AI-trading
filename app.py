# app.py - Arxora (AI) - Fixed All Unicode Issues
...
“Пока без позиции - жду более четкого сигнала. Новостной фон может сдвинуть рынок и повысить волатильность.”
],
“CONTEXT”: {
...
“neutral”: [“Рынок пока в балансе - действую только по подтвержденному сигналу.”],
...
“STOPLINE”: [
“Стоп-лосс: {sl}. Потенциальный риск ~{risk_pct}% от входа. Уровень определен алгоритмами анализа волатильности как критический для защиты капитала.”
],
...
```
    ...
    if out.get("alt"):
        st.markdown(
            f"<div style='margin-top:6px;'><b>Если пойдет против базового сценария:</b> {out['alt']}</div>",
            unsafe_allow_html=True,
        )
