...
CUSTOM_PHRASES = {
    "BUY": [
        "Точка входа: покупка в диапазоне {range_low}–{range_high}{unit_suffix}. AI-анализ выявил зону поддержку на текущем временном горизонте. Это оптимальная область для открытия позиции."
    ],
    "SHORT": [
        "Точка входа: продажа (short) в диапазоне {range_low}–{range_high}{unit_suffix}. AI-анализ выявил зону сопротивления на текущем временном горизонте. Это оптимальная область для открытия короткой позиции."
    ],
    "WAIT": [
        "Пока не вижу для себя ясной картины, я бы не торопился.",
        "Я бы пока не торопился, и подождал более точной картины. Возможно, новости могут стать триггером, и изменить ситуацию на рынке.",
        "Пока без позиции: жду более ясного сигнала. Новостной фон может сдвинуть рынок, и поменять волатильность."
    ],
    "CONTEXT": {
        "support": ["Анализ, проведённый AI, определяет эту зону как область сильной поддержки."],
        "resistance": ["Анализ, проведённый AI, определяет эту зону как область сильного сопротивления на данном горизонте."],
