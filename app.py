...
CUSTOM_PHRASES = {
    ...
    "CONTEXT": {
        "support": ["Цена подошла к поддержке, и вероятность разворота здесь повышена. Оптимальный вариант — открывать позицию на основе ордера, сгенерированного AI-анализом, рассчитанного на рост. Такой подход обеспечивает максимально точный и своевременный вход в сделку, используя большие объемы данных и реальные рыночные паттерны. Arxora учитывает множество факторов, которые трудно просчитать вручную, минимизируя эмоции и риски, и позволяя автоматически реагировать на быстро меняющиеся условия рынка. Это делает торговлю более дисциплинированной, эффективной и прибыльной в долгосрочной перспективе. При этом важно контролировать риски: закрепление ниже этой зоны поддержки будет сигналом для пересмотра сценария. Торгуйте дисциплинированно. Строго соблюдайте уровни стоп-лосса."],
        "resistance": ["Цена подошла к сопротивлению, и вероятность коррекции здесь повышена. Оптимальный вариант — открывать позицию на основе ордера, сгенерированного AI-анализом, рассчитанного на падение. При этом важно контролировать риски: закрепление выше зоны сопротивления будет сигналом для пересмотра сценария. Торгуйте дисциплинированно. Строго соблюдайте уровни стоп-лосса."],
