...
CUSTOM_PHRASES = {
    ...
    "DISCLAIMER": "Данная информация служит примером того, как AI может генерировать инвестиционные идеи, и не является прямой инвестиционной рекомендацией. Рыночная ситуация может быстро меняться, и AI адаптируется к этим изменениям. Прошлые результаты не гарантируют будущие. Торговля на финансовых рынках связана с высоким риском."
}
