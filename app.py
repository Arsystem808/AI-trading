...
CUSTOM_PHRASES = {
    ...
    "KIND_MSG": {
        ...
        "sell-stop_pulled_above": "Short • Sell Stop — цена уже прорвала сопротивление; текущая рекомендация — не входить по рынку, а рассматривать установку стоп-ордера ниже для входа при откате/сигнале слабости сверху."
    },
